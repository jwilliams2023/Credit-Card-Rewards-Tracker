...
export default function NavBar() {
    ...
    return (
        <div className="navbar bg-base-100 text-base-content bg-opacity-70 backdrop-blur duration-100 [transform:translate3d(0,0,0)] rounded-box shadow-md fixed top-0 left-0 w-full z-50">
